...
my $sharp_s = latin1_to_native("\x{DF}");
...
is(lc("\x{1E9E}"), latin1_to_native("\x{df}"), "lc(LATIN CAPITAL LETTER SHARP S)");

{
    use feature 'unicode_strings';
    use bytes;
    is(lc(latin1_to_native("\xc0")), latin1_to_native("\xc0"), "lc of above-ASCII Latin1 is itself under use bytes");
    is(lcfirst(latin1_to_native("\xc0")), latin1_to_native("\xc0"), "lcfirst of above-ASCII Latin1 is itself under use bytes");
    is(uc(latin1_to_native("\xe0")), latin1_to_native("\xe0"), "uc of above-ASCII Latin1 is itself under use bytes");
    is(ucfirst(latin1_to_native("\xe0")), latin1_to_native("\xe0"), "ucfirst of above-ASCII Latin1 is itself under use bytes");
}
